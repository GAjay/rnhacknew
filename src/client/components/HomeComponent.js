...
class HomeComponent extends React.Component {
  ...
  renderVoteCount = (item) => {
    ...
    return <span className={"vote-span"}>{votes}</span>;
  };
  ...
  renderItem = (item, index) => {
    return (
      <div>
        ...
        >
          <tr>
            <td align="middle" className={"td-header-column-width"}>
              <span className={"comments-span"}>{item.comments}</span>
            </td>
            <td align="middle" className={"td-column-width"}>
              {this.renderVoteCount(item)}
            </td>
            <td align="middle" className={"td-column-width"}>
              <a href="#" onClick={this.setUpVoteCount.bind(this, item)}>
                <img
                  src={UP_ARROW_ICON}
        ...
        >
          <tr>
            <td align="middle" className={"td-mobile-column-width"}>
              {this.renderVoteCount(item)}
            </td>
            <td align="middle" className={"td-mobile-column-width"}>
              <a href="#" onClick={this.setUpVoteCount.bind(this, item)}>
      ...
      <div className={"parent-div-container"}>
        ...
        <div className={"news-feed-container"}>
          <div className={"news-feed-header"}>
            ...
            >
              <tr>
                <td align="center" className={"td-header-column-width"}>
                  <span className={"header-label"}>Comments</span>
                </td>
                <td align="center" className={"td-header-column-width"}>
                  <span className={"header-label"}>Vote Count</span>
                </td>
                <td align="center" className={"td-header-column-width"}>
                  <span className={"header-label"}>UpVote</span>
                </td>
                <td>
                  <span className={"header-label"}>News Details</span>
                </td>
              </tr>
            </table>
            <table
            ...
            >
              <tr>
                <td align="center" className={"td-mobile-header-column-width"}>
                  <span className={"mobile-header-label"}>Vote Count</span>
                </td>
                <td align="center" className={"td-mobile-header-column-width"}>
                  <span className={"mobile-header-label"}>UpVote</span>
                </td>
                <td>
                  <span className={"mobile-header-label"}>News Details</span>
                </td>
              </tr>
            </table>
          </div>
